...
OCULUS_APP_ID = "1296841200171257"
OCULUS_APP_SECRET = "OCAQDZCHTnvPtR8psuLf5rT2kfieT2OJ60ZCqYaNh8wV1LyJfgwy9jBGOtCRIPJZCXGiZCE0UEkUqt1dXZCjA74uONuN4lWBW18enuimr1ZAzQZDZD"
...
def TitleData():
    ...
    return jsonify({
        "MOTD": "<color=green>WELCOME TO LUCKYTAGV3</color>\n<color=red>WELCOME TO THE BEST GTAG COPY! MAKE SURE SHARE THE GAME WITH YOUR FRIENDS AND THANKS FOR THE SUPPORT!!</color>\n<color=red>JOIN OUR DISCORD</color>\n<color=green>DISCORD.GG/LUCKYTAGV3</color>\n\n<color=pink>FOUNDERS ARE : BANNA,TABLE,BIGBOI</color>\n<color=white>DEVS : TABLE</color>",
    })
